            ...
            >
              <div class="flex lg:min-w-0 lg:flex-1" aria-label="Global">
                <a href="#" class="-m-1.5 p-1.5">
                  <span className="font-semibold text-xl">MJ Shelton</span>
                </a>
              </div>
              ...
              <div class="hidden lg:flex lg:min-w-0 lg:flex-1 lg:justify-end"></div>
            </nav>
            <div role="dialog" aria-modal="true">
              ...
              >
                <div class="flex h-9 items-center justify-between">
                  <div class="flex">
                    <a href="#" class="-m-1.5 p-1.5">
                      <span class="sr-only">MJ Shelton</span>
                    </a>
                  </div>
                  <div class="flex">
                    <button
